...
let virtual-env = "D:\Учёба\Учёба\ИТМО\1-й курс\Программирование\На_заказ\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Учёба\Учёба\ИТМО\1-й курс\Программирование\На_заказ\venv\Scripts\deactivate.nu"
